...
shipping = ['Free Shipping', 'Free Shipping', 'Shipping: US $0.71', 'Free Shipping', 'Free Shipping', 'Free Shipping', 'Free Shipping', 'Free Shipping', 'Free Shipping', 'Free Shipping', 'Shipping: US $1.01', 'Free Shipping', 'Free Shipping', 'Shipping: US $0.08', 'Free Shipping', 'Free Shipping', 'Free Shipping', 'Free Shipping', 'Free Shipping', 'Free Shipping', 'Free Shipping', 'Free Shipping', 'Free Shipping', 'Free Shipping', 'Free Shipping', 'Free Shipping', 'Shipping: US $0.18', 'Shipping: US $0.95', 'Free Shipping', 'Free Shipping', 'Free Shipping', 'Free Shipping', 'Free Shipping', 'Free Shipping', 'Free Shipping', 'Free Shipping', 'Free Shipping', 'Free Shipping', 'Free Shipping', 'Free Shipping', 'Free Shipping', 'Free Shipping', 'Free Shipping', 'Free Shipping', 'Free Shipping', 'Free Shipping', 'Free Shipping', 'Shipping: US $3.20', 'Free Shipping', 'Free Shipping', 'Free Shipping', 'Free Shipping', 'Free Shipping', 'Free Shipping', 'Free Shipping', 'Free Shipping', 'Free Shipping', 'Free Shipping', 'Free Shipping', 'Free Shipping']

#prices2 = [i.replace('US $', '') for i in prices]
...
#with open('C://Users/User/Desktop/Ali-Express-Web-Scraping-App/aliexpress/main/static/csv_files/tobacco.csv', 'r') as file:
    #csv_input = csv.reader(file, encode='utf-8')
...
#             continue
#         vocabulary.append(row['Product'])
#         translation.append(row['Price'])
#print(vocabulary)
#print(translation)

colnames = ['Index','Product','Price','Rating','# Sold','Supplier']
data = pandas.read_csv('C://Users/User/Desktop/Ali-Express-Web-Scraping-App/aliexpress/main/static/csv_files/tobacco.csv')
i = data.Product.tolist()
ii = data.Price.tolist()
iii = data.Rating.tolist()
iv = data.Sold.tolist()
v = data.Supplier.tolist()
vi = data.Free_Shipping.tolist()
a = [x.encode('utf-8') for x in i] #[str(x) for x in yes]
b = [str(x) for x in a]
c = [x.replace("b", '').replace("'", '') for x in b]
print(len(c), c)#
...
#result.index += 1
#df = DataFrame({'Product': titles, 'Price': prices, 'Rating':ratings }) # 'Sold':sold
#df.index += 1
#df.to_csv('C://Users/User/Desktop/Ali-Express-Web-Scraping-App/aliexpress/main/static/csv_files/testcsv.csv', index=True)
